...
public class EulerKoshiTable {
    ...
    public EulerKoshiTable(int i, double h, double x, double y, double z, double yr, double zr, double delta_z, double delta_y, double istY, double accuracy) {
        this.i = i;
        this.h = h;
